...
const RIDDLES = [
  {
    ...
    distance: '0.2mi',
    clues: [
      'I\'m louder in groups than alone',
      'I\'ve watched every Marvel film twice',
      'My happy place has 4 legs',
      'I study in Deering, never the library',
    ],
    answer: 'Marcus Bell',
    major: 'Film Studies · Sophomore',
  ...
  },
  {
    ...
    distance: '0.4mi',
    clues: [
      'My sport uses no ball',
      'I\'ve been to 3 countries this year',
      'I wake up at 5am by choice',
      'My playlist is 80% lo-fi',
    ],
    answer: 'Leila Ahmadi',
  ...
  },
  {
    ...
    distance: '0.1mi',
    clues: [
      'I can code in 4 languages (not programming)',
      'Norris is my second home',
      'I hate mornings but love sunrises',
      'My minor surprises everyone',
    ],
    answer: 'Sophia Chen',
...
export default function CommonInterestRiddles() {
  ...
  if (stage === 'signup') return (
    <div className="min-h-full flex flex-col px-6 pt-4 pb-8" style={{ background: BG, fontFamily: 'Syne, sans-serif' }}>
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold mb-2" style={{ color: DARK }}>Riddle Me</h2>
    ...
    <div className="min-h-full flex flex-col px-6 pt-4 pb-8" style={{ background: BG, fontFamily: 'Syne, sans-serif' }}>
      ...
      <div className="space-y-4 flex-1">
        {[
          ...
          { m: 'create', emoji: '✍️', title: 'Create a Riddle', desc: 'Write clues about yourself. Let others unlock you.' },
  ...
  if (stage === 'map') return (
    <div className="min-h-full px-5 pt-4 pb-8" style={{ background: BG, fontFamily: 'Syne, sans-serif' }}>
      ...
      <p className="text-xs mb-4" style={{ color: '#888' }}>3 students near you are waiting to be solved</p>
      {/* Fake map */}
      <div className="rounded-2xl overflow-hidden mb-5 relative" style={{ height: '160px', background: 'linear-gradient(135deg, #e8e0d8, #d5cdc5)' }}>
        ...
        <div className="absolute bottom-2 left-3 text-xs" style={{ color: '#888' }}>📍 You are here · Northwestern Campus</div>
      </div>
  ...
  if (stage === 'create') return (
    <div className="min-h-full flex flex-col px-5 pt-4 pb-8" style={{ background: BG, fontFamily: 'Syne, sans-serif' }}>
      ...
      <p className="text-xs mb-5" style={{ color: '#888' }}>Give 4 clues about yourself. Start vague, get specific.</p>
      <div className="space-y-3 flex-1">
  ...
  if (stage === 'published') return (
    <div className="min-h-full flex flex-col items-center justify-center px-6 pb-8" style={{ background: BG, fontFamily: 'Syne, sans-serif' }}>
      ...
      <p className="text-sm text-center mb-8 animate-fade-in delay-100" style={{ color: '#888' }}>Nearby students can now try to figure out who you are.</p>
